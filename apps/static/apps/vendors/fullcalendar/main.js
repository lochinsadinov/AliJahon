...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var BASE_OPTION_REFINERS = {
        ...
        // only used by list-views, but languages define the value, so we need it in base options
        noEventsText: String,
    ...
    */
    ...
    var ViewApi = /** @class */ (function () {
        ...
        ViewApi.prototype.getOption = function (name) {
            return this.getCurrentData().options[name]; // are the views-specific options
        };
        return ViewApi;
    }());
    ...
    */
    ...
    var ViewRoot = /** @class */ (function (_super) {
        ...
        ViewRoot.prototype.render = function () {
            ...
            return (createElement(MountHook, { hookProps: hookProps, didMount: options.viewDidMount, willUnmount: options.viewWillUnmount, elRef: props.elRef }, function (rootElRef) { return props.children(rootElRef, ["fc-" + props.viewSpec.type + "-views", 'fc-views'].concat(customClassNames)); }));
        };
        return ViewRoot;
    }(BaseComponent));
    ...
    */
    ...
    // Computes what the title at the top of the calendarApi should be for this views
        ...
        ViewContainer.prototype.render = function () {
            ...
            var classNames = [
                ...
                (aspectRatio || props.liquid || props.height)
                    ? 'fc-views-harness-active' // harness controls the height
                    : 'fc-views-harness-passive', // let the views do the height
            ];
            var height = '';
            var paddingBottom = '';
            if (aspectRatio) {
    ...
    */
    ...
    var TableDateCell = /** @class */ (function (_super) {
        ...
        TableDateCell.prototype.render = function () {
            ...
            // if colCnt is 1, we are already in a day-views and don't need a navlink
    ...
    */
    ...
    var SimpleScrollGrid = /** @class */ (function (_super) {
        ...
        function SimpleScrollGrid() {
            ...
            // TODO: can do a really simple print-views. dont need to join rows
    ...
    var MoreLinkRoot = /** @class */ (function (_super) {
        ...
        function MoreLinkRoot() {
            ...
            _this.handleClick = function (ev) {
                ...
                else if (typeof moreLinkClick === 'string') { // a views name
        ...
        MoreLinkRoot.prototype.updateParentEl = function () {
            if (this.linkElRef.current) {
                this.parentEl = elementClosest(this.linkElRef.current, '.fc-views-harness');
            }
        };
        return MoreLinkRoot;
    }(BaseComponent));
        ...
        TableRow.prototype.renderFgSegs = function (col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            if (framePositions) {
                for (var _i = 0, segPlacements_1 = segPlacements; _i < segPlacements_1.length; _i++) {
                    ...
                    todo: in print views, for multi-day events, don't display title within non-start/end segs
                    */
                ...
                createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) { return (createElement(Fragment, null,
                    createElement("table", { className: "fc-scrollgrid-sync-table", style: {
                        ...
                        createElement("tbody", null, props.cells.map(function (cells, row) { return (createElement(TableRow, { ref: _this.rowRefs.createRef(row), key: cells.length
                                ...
                                : row // in case there are no cells (like when resource views is loading)
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        function TimeColsView() {
            ...
            _this.renderTableRowAxis = function (rowHeight) {
                ...
                return (
                // TODO: make reusable hook. used in list views too
