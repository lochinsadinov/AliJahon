  ...
  if (window.List) {
    ...
    if (lists.length) {
      lists.forEach(function (el) {
        ...
        var viewAll = el.querySelector('[data-list-views="*"]');
        var viewLess = el.querySelector('[data-list-views="less"]');
...
var appCalendarInit = function appCalendarInit() {
  var Selectors = {
    ...
    DATA_CALENDAR_VIEW: '[data-fc-views]',
    DATA_EVENT: '[data-event]',
    DATA_VIEW_TITLE: '[data-views-title]',
